Ext.define('isane.view.aq_yb_lr_hb.hbList',{
	extend:'Ext.grid.Panel',
	alias:'widget.aq_yb_lr_hb-hbList',
	id: 'aq_yb_lr_hb-hbList-id',
	store: Ext.create('isane.store.original.original',{storeId: 'aq_yb_lr_hb-hbList-storeId'}),
	plugins: [
  	...
  	'所属单位:',
	{
		xtype: 'textfield',
		name: 'organCode',
		id: 'aq_yb_lr_hb-hbList-organCode',
		readOnly: true,
		width: 100,
	...
	},'-',			
	{
		...
		listeners: {
			change: function(own){
				var y = Ext.getCmp('aq_yb_lr_hb-hbList-storeY').getValue(); 
				var m = Ext.getCmp('aq_yb_lr_hb-hbList-storeM').getValue(); 
	...
	{
		text: '搜索',
	    id: 'aq_yb_lr_hb-hbList-searchButton',
	    tooltip:'搜索数据',
	    disabled: true,
        iconCls: 'search'		
	},'-',
	{
		...
		iconCls: 'ok1',
		disabled: true,
		id: 'aq_yb_lr_hb-hbList-saveButton'
	},'-',
	{
		text: '导入',
		tooltip:'导入数据',
		iconCls: 'list_import',
		disabled: true,
		id: 'aq_yb_lr_hb-hbList-importButton'
	},'-',	
	{
		text: '刷新',
		tooltip:'刷新数据',
