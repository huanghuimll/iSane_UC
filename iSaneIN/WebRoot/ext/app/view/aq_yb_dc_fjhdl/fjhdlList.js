Ext.define('isane.view.aq_yb_dc_fjhdl.fjhdlList',{
	extend:'Ext.grid.Panel',
	alias:'widget.aq_yb_dc_fjhdl-fjhdlList',
	id: 'aq_yb_dc_fjhdl-fjhdlList-id',
	//store: Ext.create('isane.store.original.original',{storeId: 'aq_yb_dc_fjhdl-fjhdlList-storeId'}),
	plugins: [
  	...
  	'所属单位:',
	{
		...
		name:'organCode',
		id: 'aq_yb_dc_fjhdl-fjhdlList-organCode',
		displayField : 'name',
		valueField : 'id',
		editable: false,
		allowBlank: true,
	...
	'日期:',
	{
		xtype:'numberfield',
		name: 'storeY',
		id: 'aq_yb_dc_fjhdl-fjhdlList-storeY',
		width: 70,
		minValue: 2016,
	...
	},
	{
		xtype:'numberfield',
		name: 'storeM',
		id: 'aq_yb_dc_fjhdl-fjhdlList-storeM',
		width: 70,
		minValue: 1,
		maxValue: 12,
	...
	},			
	{
		xtype:'numberfield',
		name: 'storeD',
		id: 'aq_yb_dc_fjhdl-fjhdlList-storeD',
		width: 70,
		minValue: 1,
		maxValue: 31,
		value: 1,
		...
		/*listeners: {
			change: function(own){
				var y = Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-storeY').getValue(); 
				var m = Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-storeM').getValue(); 
	...
	},'-',	
	{
		...
		tooltip:'导出报表',
		iconCls: 'list_export',
		id: 'aq_yb_dc_fjhdl-fjhdlList-exportButton'
	},'-'//,		
	/*{
		text: '搜索',
	    id: 'aq_yb_dc_fjhdl-fjhdlList-searchButton',
	    tooltip:'搜索数据',
        iconCls: 'search'		
	},'-',
	{
		...
		iconCls: 'ok1',
		id: 'aq_yb_dc_fjhdl-fjhdlList-saveButton'
	},'-',
	{
		text: '刷新',
		tooltip:'刷新数据',
