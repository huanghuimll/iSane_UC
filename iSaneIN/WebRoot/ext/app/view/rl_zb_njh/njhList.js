Ext.define('isane.view.rl_zb_njh.njhList',{
	extend:'Ext.grid.Panel',
	alias:'widget.rl_zb_njh-njhList',
	id: 'rl_zb_njh-njhList-id',
	store: Ext.create('isane.store.original.original',{storeId: 'rl_zb_njh-njhList-storeId'}),
	plugins: [
  	...
  	'所属单位:',
	{
		xtype: 'textfield',
		name: 'organCode',
		id: 'rl_zb_njh-njhList-organCode',
		readOnly: true,
		width: 100,
	...
	},'-',			
	{
		...
		listeners: {
			change: function(own){
				var y = Ext.getCmp('rl_zb_njh-njhList-storeY').getValue(); 
				var m = Ext.getCmp('rl_zb_njh-njhList-storeM').getValue(); 
	...
	{
		text: '搜索',
	    id: 'rl_zb_njh-njhList-searchButton',
	    tooltip:'搜索数据',
	    disabled: true,
        iconCls: 'search'		
	},'-',
	{
		...
		iconCls: 'ok1',
		disabled: true,
		id: 'rl_zb_njh-njhList-saveButton'
	},'-',	
	{
		text: '刷新',
		tooltip:'刷新数据',
