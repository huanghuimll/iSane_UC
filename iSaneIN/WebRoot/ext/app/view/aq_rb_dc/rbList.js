Ext.define('isane.view.aq_rb_dc.rbList',{
	extend:'Ext.grid.Panel',
	alias:'widget.aq_rb_dc-rbList',
	id: 'aq_rb_dc-rbList-id',
	//store: Ext.create('isane.store.original.original',{storeId: 'aq_rb_dc-rbList-storeId'}),
	plugins: [
	...
	},'-',	
	{
		...
		tooltip:'导出报表',
		iconCls: 'list_export',
		id: 'aq_rb_dc-rbList-exportButton'
	},'-'//,		
	/*{
		text: '搜索',
	    id: 'aq_rb_dc-rbList-searchButton',
	    tooltip:'搜索数据',
        iconCls: 'search'		
	},'-',
	{
