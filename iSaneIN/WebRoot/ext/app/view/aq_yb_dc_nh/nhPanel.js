  	...
  	'所属单位:',
    	{
    		...
    		name:'organCode',
    		id: 'aq_yb_dc_nh-nhPanel-organCode',
    		displayField : 'name',
    		valueField : 'id',
    		editable: false,
    		allowBlank: true,
    	...
    	{
    		text: '搜索',
    		id: 'aq_yb_dc_nh-nhPanel-searchButton',
    		tooltip:'搜索数据',
    		iconCls: 'search'		
    	},'-',	
    	{
    		...
    		tooltip:'导出报表',
    		iconCls: 'list_export',
    		id: 'aq_yb_dc_nh-nhPanel-exportButton'
    	},'-'
      ],	
  	items:[
     	{
