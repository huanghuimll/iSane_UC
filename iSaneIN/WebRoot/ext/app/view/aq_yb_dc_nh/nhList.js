Ext.define('isane.view.aq_yb_dc_nh.nhList',{
	extend:'Ext.grid.Panel',
	alias:'widget.aq_yb_dc_nh-nhList',
	id: 'aq_yb_dc_nh-nhList-id',
	//store: Ext.create('isane.store.original.original',{storeId: 'aq_yb_dc_nh-nhList-storeId'}),
	plugins: [
  	...
  	'所属单位:',
	{
		...
		name:'organCode',
		id: 'aq_yb_dc_nh-nhList-organCode',
		displayField : 'name',
		valueField : 'id',
		editable: false,
		allowBlank: true,
	...
	},			
	{
		...
		/*listeners: {
			change: function(own){
				var y = Ext.getCmp('aq_yb_dc_nh-nhList-storeY').getValue(); 
				var m = Ext.getCmp('aq_yb_dc_nh-nhList-storeM').getValue(); 
	...
	},'-',	
	{
		...
		tooltip:'导出报表',
		iconCls: 'list_export',
		id: 'aq_yb_dc_nh-nhList-exportButton'
	},'-'//,		
	/*{
		text: '搜索',
	    id: 'aq_yb_dc_nh-nhList-searchButton',
	    tooltip:'搜索数据',
        iconCls: 'search'		
	},'-',
	{
		...
		iconCls: 'ok1',
		id: 'aq_yb_dc_nh-nhList-saveButton'
	},'-',
	{
		text: '刷新',
		tooltip:'刷新数据',
