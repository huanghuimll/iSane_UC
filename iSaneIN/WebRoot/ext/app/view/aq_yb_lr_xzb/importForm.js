 Ext.define('isane.view.aq_yb_lr_xzb.importForm',{
    extend:'Ext.form.Panel',
    alias:'widget.aq_yb_lr_xzb-importForm',
    border:0,
    bodyPadding:'5 5 5 5',
    frame: true, 
    items:[
    {
    	...
    	},    	        
    	{
    		xtype: 'textfield',
    		name: 'dateType',
    		id: 'aq_yb_lr_xzb-importForm-dateType',
    		fieldLabel: '类型',
    		value: 'M',
    		hidden: true
    	},    	         	        
    	{
    		...
    		value: new Date(),
            minValue: '2016/01/01',
            id: 'aq_yb_lr_xzb-importForm-storeDate',
    		emptyText: '输入时间..'	
    	},	   	        
    	/*{
    		xtype: 'datefield',
