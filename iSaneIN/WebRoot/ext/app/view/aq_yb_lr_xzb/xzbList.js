Ext.define('isane.view.aq_yb_lr_xzb.xzbList',{
	extend:'Ext.grid.Panel',
	alias:'widget.aq_yb_lr_xzb-xzbList',
	id: 'aq_yb_lr_xzb-xzbList-id',
	store: Ext.create('isane.store.original.original',{storeId: 'aq_yb_lr_xzb-xzbList-storeId'}),
	plugins: [
  	...
  	'所属单位:',
	{
		xtype: 'textfield',
		name: 'organCode',
		id: 'aq_yb_lr_xzb-xzbList-organCode',
		readOnly: true,
		width: 100,
	...
	'日期:',
	{
		xtype:'numberfield',
		name: 'storeY',
		id: 'aq_yb_lr_xzb-xzbList-storeY',
		width: 70,
		minValue: 2016,
	...
	},
	{
		xtype:'numberfield',
		name: 'storeM',
		id: 'aq_yb_lr_xzb-xzbList-storeM',
		width: 70,
		minValue: 1,
		maxValue: 12,
	...
	},'-',			
	{
		xtype:'numberfield',
		name: 'storeD',
		id: 'aq_yb_lr_xzb-xzbList-storeD',
		width: 70,
		minValue: 1,
		maxValue: 31,
		hidden: true,
		...
		listeners: {
			change: function(own){
				var y = Ext.getCmp('aq_yb_lr_xzb-xzbList-storeY').getValue(); 
				var m = Ext.getCmp('aq_yb_lr_xzb-xzbList-storeM').getValue(); 
	...
	},'-',
	{
		...
		iconCls: 'list_import',
		disabled: true,
		id: 'aq_yb_lr_xzb-xzbList-importButton'
	},'-',	
	{
		text: '刷新',
		tooltip:'刷新数据',
		iconCls: 'refresh',
		disabled: true,
		id: 'aq_yb_lr_xzb-xzbList-refresh',
