	...
	'所属单位:',
  	{
  		...
  		name:'organCode',
  		id: 'aq_yb_dc_xzb-xzbPanel-organCode',
  		displayField : 'name',
  		valueField : 'id',
  		editable: false,
  		allowBlank: true,
  	...
  	'日期:',
  	{
  		xtype:'numberfield',
  		name: 'storeY',
  		id: 'aq_yb_dc_xzb-xzbPanel-storeY',
  		width: 70,
  		minValue: 2016,
  	...
  	},
  	{
  		xtype:'numberfield',
  		name: 'storeM',
  		id: 'aq_yb_dc_xzb-xzbPanel-storeM',
  		width: 70,
  		minValue: 1,
  		maxValue: 12,
  	...
  	},			
  	{
  		xtype:'numberfield',
  		name: 'storeD',
  		id: 'aq_yb_dc_xzb-xzbPanel-storeD',
  		width: 70,
  		minValue: 1,
  		maxValue: 31,
  		value: 1,
  	...
  	{
  		text: '搜索',
  		id: 'aq_yb_dc_xzb-xzbPanel-searchButton',
  		tooltip:'搜索数据',
  		iconCls: 'search'		
  	},'-',	
  	{
