Ext.define('isane.view.aq_yb_lr_njh.njhList',{
	extend:'Ext.grid.Panel',
	alias:'widget.aq_yb_lr_njh-njhList',
	id: 'aq_yb_lr_njh-njhList-id',
	store: Ext.create('isane.store.original.original',{storeId: 'aq_yb_lr_njh-njhList-storeId'}),
	plugins: [
  	...
  	'所属单位:',
	{
		xtype: 'textfield',
		name: 'organCode',
		id: 'aq_yb_lr_njh-njhList-organCode',
		readOnly: true,
		width: 100,
	...
	'日期:',
	{
		xtype:'numberfield',
		name: 'storeY',
		id: 'aq_yb_lr_njh-njhList-storeY',
		width: 70,
		minValue: 2016,
	...
	},
	{
		xtype:'numberfield',
		name: 'storeM',
		id: 'aq_yb_lr_njh-njhList-storeM',
		width: 70,
		minValue: 1,
		maxValue: 12,
		hidden: true,
	...
	},'-',			
	{
		xtype:'numberfield',
		name: 'storeD',
		id: 'aq_yb_lr_njh-njhList-storeD',
		width: 70,
		minValue: 1,
		maxValue: 31,
		hidden: true,
		...
		listeners: {
			change: function(own){
				var y = Ext.getCmp('aq_yb_lr_njh-njhList-storeY').getValue(); 
				var m = Ext.getCmp('aq_yb_lr_njh-njhList-storeM').getValue(); 
	...
	{
		text: '搜索',
	    id: 'aq_yb_lr_njh-njhList-searchButton',
	    tooltip:'搜索数据',
	    disabled: true,
        iconCls: 'search'		
	},'-',
	{
		...
		iconCls: 'ok1',
		disabled: true,
		id: 'aq_yb_lr_njh-njhList-saveButton'
	},'-',	
	{
		text: '刷新',
		tooltip:'刷新数据',
		iconCls: 'refresh',
		disabled: true,
		id: 'aq_yb_lr_njh-njhList-refresh',
