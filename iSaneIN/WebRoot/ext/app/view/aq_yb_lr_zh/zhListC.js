Ext.define('isane.view.aq_yb_lr_zh.zhListC',{
	extend:'Ext.grid.Panel',
	alias:'widget.aq_yb_lr_zh-zhListC',
	id: 'aq_yb_lr_zh-zhListC-id',
	store: Ext.create('isane.store.original.original',{storeId: 'aq_yb_lr_zh-zhListC-storeId'}),
	plugins: [
  	...
  	'所属单位:',
	{
		xtype: 'textfield',
		name: 'organCode',
		id: 'aq_yb_lr_zh-zhListC-organCode',
		readOnly: true,
		width: 100,
	...
	},			
	{
		...
		listeners: {
			change: function(own){
				var y = Ext.getCmp('aq_yb_lr_zh-zhListC-storeY').getValue(); 
				var m = Ext.getCmp('aq_yb_lr_zh-zhListC-storeM').getValue(); 
	...
	{
		text: '搜索',
	    id: 'aq_yb_lr_zh-zhListC-searczhutton',
	    tooltip:'搜索数据',
	    disabled: true,
        iconCls: 'search'		
	},'-',
	{
		...
		iconCls: 'ok1',
		disabled: true,
		id: 'aq_yb_lr_zh-zhListC-saveButton'
	},'-',
	/*{
		text: '上传',
		tooltip:'导入数据',
		iconCls: 'list_import',
		disabled: true,
		id: 'aq_yb_lr_zh-zhListC-importButton'
	},'-',*/
	{
		text: '刷新',
		tooltip:'刷新数据',
		iconCls: 'refresh',
		disabled: true,
		id: 'aq_yb_lr_zh-zhListC-refresh',
