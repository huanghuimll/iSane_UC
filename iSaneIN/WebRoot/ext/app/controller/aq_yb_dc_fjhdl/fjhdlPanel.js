Ext.define('isane.controller.aq_yb_dc_fjhdl.fjhdlPanel', {
	...
	//stores : ['aq_yb_dc_fjhdl.rbTree'],
	//models : ['organtree'],	
	views : ['aq_yb_dc_fjhdl.fjhdlPanel', 'aq_yb_dc_fjhdl.fjhdlList'],
	init: function() {
		this.control({
			//fjhdl月报导出
			'aq_yb_dc_fjhdl-fjhdlList button[text=导出]':{
				click: this.exportBtn
			},
			/*'aq_yb_dc_fjhdl-fjhdlPanel':{
				beforerender: this.onBeforeRender
			},				
			'aq_yb_dc_fjhdl-rbWest':{
    			itemclick: this.itemclick_dt
    		},
    		'aq_yb_dc_fjhdl-fjhdlList button[text=搜索]':{
				click:this.click_search
			},			
			'aq_yb_dc_fjhdl-fjhdlList button[text=保存]':{
				click: this.saveAll
			},				
			'aq_yb_dc_fjhdl-fjhdlList actioncolumn':{
	...
	exportBtn: function(btn){
		var organCode = Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-organCode').getValue();
		var storeY = Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-storeY').getValue();
		var storeM = Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-storeM').getValue();
		var storeD = Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-storeD').getValue();
	...
	onBeforeRender: function(item){
		var own = Ext.getCmp('aq_yb_dc_fjhdl-rbWest-id');
    ...
    itemclick_dt: function(own, record, item, index, e, eOpts){
		...
		Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-organCode').setValue(organCode);
		
		var grid = Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-id');
	...
	afterrender: function(panel){
		...
		var obt = {
				plantCode: Ext.getCmp('aq_yb_dc_fjhdl-fjhdlList-organCode').getValue(),
				dataType: 'RB_PT',
